...
<div role="main" class="container" style="margin-top: 100px;">
	...
	<form action="${pageContext.request.contextPath}/uploads" method="post" enctype="multipart/form-data">
			...
			<div class="input-group form-group">
				...
				<input type="file" name="path" class="form-control" style="min-width:200px;"/>
	    		<input type="submit" name="btn_file_upload" value="Upload" class="btn btn-dark float-right login_btn"/>				
			</div>
			<%--
			<div class="input-group form-group">
 				<div class="input-group-prepend">
